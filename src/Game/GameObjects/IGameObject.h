...
public:
	...
	virtual float getCurrentVelocity() const { return m_velocity; }
	virtual void setVelocity(const double velocity);

	const glm::vec2& getSize() const { return m_size; }
	const std::vector<Physics::AABB>& getColliders() const { return m_collides; }
...
protected:
	...
	std::vector <Physics::AABB> m_collides;
};